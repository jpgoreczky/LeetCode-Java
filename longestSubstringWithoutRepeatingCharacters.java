class Solution {
    public int lengthOfLongestSubstring(String s) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            // if the current char is in the set, it'll remove the original duplicate char from the set
            // and increment the second pointer to the next index
            // when the set no longer has the duplicate characters in the set, it'll add the current char
